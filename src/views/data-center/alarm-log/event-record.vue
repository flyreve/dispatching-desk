<!--page: 事件-->
<template>
  <div class="event-record width-page">
    <div class="page-header">事件告警记录</div>
    <div class="data-type">
      <div class="type-item">事件告警：9999</div>
    </div>
    ...
    <div class="data-content">
      <el-table
        ...
        <el-table-column align="center" prop="k4" width="120">
          <!--上报地点弹窗-->
          <el-popover
                  slot="header"
                  placement="bottom"
        ...
        <el-table-column align="center" prop="k7" label="备注"></el-table-column>
      </el-table>
      <el-pagination
              class="mt-10 fr"
              background
  ...
  export default {
    ...
    data() {
      ...
      return {
        currentPage1: 5,
        tableData: [
          {'k1':  '部门名称', 'k2':  '成员名称', 'k3':  '事件名称', 'k4':  '云南省昆明市五华区北门街', 'k5':  '2019年12月1日', 'k6':  '已完成/未完成', 'k7':  '99', 'k8':  '99', 'k9':  '文档'},
          {'k1':  '部门名称', 'k2':  '成员名称', 'k3':  '事件名称', 'k4':  '云南省昆明市五华区北门街', 'k5':  '2019年12月1日', 'k6':  '已完成/未完成', 'k7':  '99', 'k8':  '99', 'k9':  '文档'},
          {'k1':  '部门名称', 'k2':  '成员名称', 'k3':  '事件名称', 'k4':  '云南省昆明市五华区北门街', 'k5':  '2019年12月1日', 'k6':  '已完成/未完成', 'k7':  '99', 'k8':  '99', 'k9':  '文档'},
          {'k1':  '部门名称', 'k2':  '成员名称', 'k3':  '事件名称', 'k4':  '云南省昆明市五华区北门街', 'k5':  '2019年12月1日', 'k6':  '已完成/未完成', 'k7':  '99', 'k8':  '99', 'k9':  '文档'},
          {'k1':  '部门名称', 'k2':  '成员名称', 'k3':  '事件名称', 'k4':  '云南省昆明市五华区北门街', 'k5':  '2019年12月1日', 'k6':  '已完成/未完成', 'k7':  '99', 'k8':  '99', 'k9':  '文档'},
