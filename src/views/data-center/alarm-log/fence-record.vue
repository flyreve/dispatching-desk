<!--page: 围栏-->
<template>
  <div class="fence-record width-page">
    <div class="page-header">围栏告警记录</div>
    <div class="data-type">
      <div class="type-item">围栏告警：9999</div>
    </div>
      ...
      <el-table
        ...
        <el-table-column align="center" prop="k3">
          ...
          <el-popover
            ...
            <el-link :underline="false" slot="reference">
              围栏 <i class="el-icon-arrow-down fz-10"></i>
            </el-link>
          </el-popover>
        </el-table-column>
