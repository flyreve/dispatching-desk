<!--page: 任务-->
<template>
  <div class="task-record width-page">
    <div class="page-header">任务告警记录</div>
    <div class="data-type">
      <div class="type-item">任务告警：9999</div>
    </div>
    ...
    <div class="data-content">
      <el-table
        ...
        <el-table-column align="center" prop="k6">
          <!--任务弹窗-->
          <el-popover
                  slot="header"
                  placement="bottom"
        ...
        <el-table-column align="center" prop="k7">
          <!--区域弹窗-->
          <el-popover
                  slot="header"
                  placement="bottom"
        ...
        <el-table-column align="center" prop="k8">
          <!--标签弹窗-->
          <el-popover
                  slot="header"
                  placement="bottom"
        ...
        <el-table-column align="center" prop="k4" label="告警地点"></el-table-column>
        <el-table-column align="center" prop="k5" label="告警时间"></el-table-column>
      </el-table>
      <el-pagination
              class="mt-10 fr"
              background
  ...
  export default {
    ...
    data() {
      ...
      return {
        currentPage1: 5,
        tableData: [
          {'k1':  '部门名称', 'k2':  '成员名称', 'k3':  '任务名称', 'k4':  '云南省昆明市五华区北门街', 'k5':  '2019年12月1日', 'k6':  '任务名称', 'k7':  '区域名称', 'k8':  '标签名称',},
          {'k1':  '部门名称', 'k2':  '成员名称', 'k3':  '任务名称', 'k4':  '云南省昆明市五华区北门街', 'k5':  '2019年12月1日', 'k6':  '任务名称', 'k7':  '区域名称', 'k8':  '标签名称',},
          {'k1':  '部门名称', 'k2':  '成员名称', 'k3':  '任务名称', 'k4':  '云南省昆明市五华区北门街', 'k5':  '2019年12月1日', 'k6':  '任务名称', 'k7':  '区域名称', 'k8':  '标签名称',},
          {'k1':  '部门名称', 'k2':  '成员名称', 'k3':  '任务名称', 'k4':  '云南省昆明市五华区北门街', 'k5':  '2019年12月1日', 'k6':  '任务名称', 'k7':  '区域名称', 'k8':  '标签名称',},
          {'k1':  '部门名称', 'k2':  '成员名称', 'k3':  '任务名称', 'k4':  '云南省昆明市五华区北门街', 'k5':  '2019年12月1日', 'k6':  '任务名称', 'k7':  '区域名称', 'k8':  '标签名称',},
